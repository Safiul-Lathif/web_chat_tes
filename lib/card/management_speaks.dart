...
class ManagementSpeaks extends StatefulWidget {
  const ManagementSpeaks({
    super.key,
    required this.data,
  ...
  @override
  State<ManagementSpeaks> createState() => _ManagementSpeaksState();
}

class _ManagementSpeaksState extends State<ManagementSpeaks> {
