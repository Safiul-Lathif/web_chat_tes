...
class _AddEditManagementPageState extends State<AddEditManagementPage> {
  ManagementList? userModel;
  ...
  void initialize() async {
    setState(() {
      ...
      if (!widget.isEdit) {
        widget.userModel = ManagementList(
            id: 0,
            firstName: '',
            mobileNumber: 0,
            userStatus: 0,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(widget.isEdit ? "Edit Management" : "Add New Management"),
          centerTitle: true,
          leading: IconButton(
                    ...
                    child: Column(children: [
                      ...
                      Container(
                        ...
                        child: FormBuilderDropdown(
                          initialValue: widget.userModel.designation == ''
                              ? null
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              await addEditManagement(widget.userModel,
