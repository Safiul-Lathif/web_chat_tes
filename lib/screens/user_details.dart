...
import 'package:ui/pages/change_password.dart';
...
class _UserDetailsScreenState extends State<UserDetailsScreen> {
  ...
  void onSave(image, BuildContext ctx) async {
    await editYourProfile(profileImage: selectedPicture, userName: '');
    setState(() {
      profiles = null;
      Navigator.pop(ctx);
    });
                                                                    ...
                                                                    selectedPicture
                                                                        ...
                                                                        : Center(
                                                                            child:
                                                                              ...
                                                                              height: 130,
                                                                              width: 130,
                                                                              decoration: BoxDecoration(color: Colors.transparent, shape: BoxShape.circle, image: DecorationImage(image: MemoryImage(selectedPicture[0].bytes!), fit: BoxFit.cover), border: Border.all(color: Colors.blueGrey.shade600, width: 2)),
                                                                            ),
                                                                          ),
                                                                    Center(
                                                                      child:
