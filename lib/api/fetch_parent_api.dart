...
import 'package:ui/model/fetch_parent_model.dart';

import 'package:ui/utils/session_management.dart';

Future<FetchparentList?> fetchparent({required String id}) async {
  var url =
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      return FetchparentList.fromJson(jsonResponse);
    } else {
